...
const config = {
  "generator": {
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\Admin\\Desktop\\GatePass\\src\\packages\\database\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
  ...
  "inlineSchemaHash": "8c6ad79c81de6625e8cfb6343590c0339e068b1149b0787422b7e2a8bc07bbd9",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/packages/database/generated/client",
...
path.join(process.cwd(), "src/packages/database/generated/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/packages/database/generated/client/schema.prisma")
