import{r as t,j as e}from"./index-DTnNYmHn.js";import{T as v}from"./ticket-CW1_par5.js";function u({onComplete:r}){const[l,n]=t.useState(!1),a=t.useMemo(()=>"GatePass",[]),[o,c]=t.useState("");return t.useEffect(()=>{const m=setTimeout(()=>n(!0),80),d=setTimeout(()=>r(),3e3);let s=0;const i=setInterval(()=>{s+=1,c(a.slice(0,s)),s>=a.length&&clearInterval(i)},140);return()=>{clearTimeout(m),clearTimeout(d),clearInterval(i)}},[r,a]),e.jsxs("div",{className:"min-h-svh w-full relative overflow-hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-white"}),e.jsxs("div",{className:"absolute inset-0 pointer-events-none",children:[e.jsx("div",{className:"absolute",style:{top:"15vh",left:"-10vw",width:"60vw",height:"60vw",borderRadius:"30vw",backgroundColor:"rgba(0,0,0,0.12)",animation:"gpFloat1 20s ease-in-out infinite"}}),e.jsx("div",{className:"absolute",style:{top:"55vh",left:"55vw",width:"50vw",height:"50vw",borderRadius:"25vw",backgroundColor:"rgba(0,0,0,0.10)",animation:"gpFloat2 22s ease-in-out infinite"}}),e.jsx("div",{className:"absolute",style:{top:"-5vh",left:"40vw",width:"45vw",height:"45vw",borderRadius:"22.5vw",backgroundColor:"rgba(0,0,0,0.08)",animation:"gpFloat3 24s ease-in-out infinite"}}),e.jsx("style",{children:`
          @keyframes gpFloat1 {
